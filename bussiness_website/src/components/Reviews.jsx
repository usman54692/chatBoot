  ...
  return (
    <>
      <article>
          ...
          <div className="font-medium  dark:text-white">
            <p>
              ...
              <time
                ...
                className="block text-sm text-white dark:text-gray-400"
              >
        ...
        <div className="flex items-center justify-center mb-1 space-x-1 rtl:space-x-reverse">
          <svg
          ...
          <h3 className="ms-2 text-sm font-semibold text-white dark:text-white">
            Thinking to buy another one!
          </h3>
        </div>
        <footer className="mb-5  text-sm text-center text-white dark:text-gray-400">
          <p>
            Reviewed in the United Kingdom on{" "}
            <time datetime="2017-03-03 19:00">March 3, 2017</time>
          </p>
        </footer>
        <p className="mb-2 text-white text-center dark:text-gray-400">
        ...
        <p className="mb-3 text-center text-white dark:text-gray-400">
        ...
        <a
          href="#"
          className="block mb-5 text-sm text-center font-medium text-blue-600 hover:underline dark:text-blue-500"
        >
          Read more
        </a>
        <aside>
          <p className="mt-1 text-xs text-center text-white dark:text-gray-400">
