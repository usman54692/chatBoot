...
const PaymentPlans = ({stage}) => {
  return (
    <>
      <div className="w-full max-w-sm  bg-basedark border border-gray-200 rounded-lg items-center  shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
        <h5 className="mb-4 text-xl font-medium text-center p-5 dark:text-gray-400 bg-Green text-white">
          {stage}
        </h5>
        <div className="flex p-5 items-center  text-white dark:text-white">
        ...
        <ul role="list" className="space-y-5 my-7 p-5 text-white">
          <li className="flex ">
            <svg
            ...
            <span className="text-base font-normal leading-tight text-white dark:text-gray-400 ms-3 text-justify">
...
You receive support via phone, email and message for the duration.
          ...
          <li className="flex line-through decoration-gray-500">
            <svg
              className="flex-shrink-0 w-4 h-4 text-white dark:text-gray-500"
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              viewBox="0 0 20 20"
